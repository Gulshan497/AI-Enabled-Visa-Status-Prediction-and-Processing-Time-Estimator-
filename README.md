...
**To run the site, make sure to run the backend first then proceed to clicking on the frontend to make the prediction functional.**

## 🚀 Live Deployment

- **Frontend:** https://visa-estimator-frontend-final.onrender.com/
...
This project aims to simplify the visa process by providing transparent, AI-assisted predictions, helping users make informed decisions while reducing uncertainty. 
It can be integrated into academic research, advisory services, or personal application planning tools.
